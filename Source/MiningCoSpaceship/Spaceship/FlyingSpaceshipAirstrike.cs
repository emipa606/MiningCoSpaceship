...
public class FlyingSpaceshipAirstrike : FlyingSpaceship
{
    ...
    public List<int> weaponNextShotTick = new List<int>(3) { 0, 0, 0 };

    public List<int> weaponRemainingRounds = new List<int>(3) { -1, -1, -1 };

    public List<bool> weaponShootRight = new List<bool>(3) { true, true, true };
