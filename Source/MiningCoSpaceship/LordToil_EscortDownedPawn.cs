...
public class LordToil_EscortDownedPawn : LordToil
{
    ...
    public override void UpdateAllDuties()
    {
        ...
        foreach (var pawn in lord.ownedPawns)
        {
            ...
            {
                var duty = new PawnDuty(Util_DutyDefOf.DutyDef_CarryDownedPawn, Data.targetDestination);
                pawn.mindState.duty = duty;
            }
            else
            {
                var duty2 = new PawnDuty(Util_DutyDefOf.DutyDef_EscortCarrier, Data.carrier, 5f);
